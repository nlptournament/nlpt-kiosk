...
class Setting(SettingBase):
    _defaults = {
        ...
        'challonge_user':        {'order': 11, 'type': 'str',  'value': None,       'desc': 'Challonge username used for API connection'},
        'challonge_key':         {'order': 12, 'type': 'str',  'value': None,       'desc': 'Challonge API-key used for connection'},
        'challonge_img_user_id': {'order': 13, 'type': 'str',  'value': None,       'desc': 'user_id of User who is owning Media for Challonge Screens'},
